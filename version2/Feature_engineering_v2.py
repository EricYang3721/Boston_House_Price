...
# log1p these TotalBsmtSF, Garage area
...
# Correlation
train_data_combine = pd.concat([all_data_new.iloc[0:1458,:], 
...
# 8 Separate into training and test set
...
y_train.to_csv('y_train_v2.csv', header = ['lgSalePrice'], index=False)
impo_features.to_csv('feature_correlation_to_label.csv', header=['features', 'correlation'], index=False)
