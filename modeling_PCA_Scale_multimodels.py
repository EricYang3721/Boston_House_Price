# 150 features, with scaling, multiple algorithom
# Modeling with PCA
# Price prediction
import pandas as pd
import numpy as np
...
X_train = pca.fit_transform(X_train).copy()
...
plt.show()
min(lasso_scores)
# Lowest RMSE for Ridge Regression is 0.11395
...
plt.show()
min(rge_scores)
# Lowest RMSE for Ridge Regression is 0.1421
...
# RMSE of GradientBosting is 0.14946